...
export const faqs: FAQ[] = [
  ...
  {
    id: "2",
    question: "How long does it take to set up my invite?",
    answer:
      "Most couples finish in under 60 minutes. You fill in names, dates, venues, and upload a photo or two. Preview it, make any tweaks, and it's ready to share — all in one sitting.",
  },
  {
    id: "3",
  ...
  {
    id: "4",
    question: "Can I preview the invite before sharing it?",
    answer:
      "Yes. Before you publish, you can preview exactly how your invite looks on mobile, tablet, and desktop. You can also share a private preview link with a close family member to get their approval before going live.",
  },
  {
    id: "5",
  ...
  {
    id: "8",
    question: "What's included in the template purchase?",
    answer:
      "Your purchase includes full access to the invite editor, unlimited updates to your invite content, RSVP collection, Google Maps integration, background music upload, photo gallery, and hosting for 12 months. There are no hidden fees.",
  },
  {
    id: "9",
  ...
  },
  {
    ...
    answer:
      "We offer a full refund within 48 hours of purchase if you haven't yet published your invite. Once the invite is live and shared, we're unable to process refunds. If you face any issue setting up your invite, our support team will help you resolve it — just write to us.",
  },
  {
    id: "13",
    question: "Is this better than a WhatsApp video invite?",
    answer:
      "Very much so. Video invites are beautiful but they can't be updated, they compress poorly on WhatsApp, they don't include clickable maps or RSVPs, and they take up storage on guests' phones. A wedding website invite is lighter, smarter, and always up to date. Guests bookmark it, not delete it.",
  },
  {
    id: "14",
    question: "Can I get help if I'm stuck while setting up?",
    answer:
